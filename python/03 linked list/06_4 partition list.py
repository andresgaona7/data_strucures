...
class LinkedList:
    ...
    def partition_list(self, index):
        temp = self.head
        minor = major = None
        minor_head = major_head = minor_tail = None
        for _ in range(self.length):
            if(temp.value < index):
                ...
                if major is None:
                    ...
                    major.next = Node(temp.value)
                    major = major.next
                
            temp = temp.next
        
        if minor_head is None:
            self.head = major_head
            return 
        
        minor_tail.next = major_head
        self.head = minor_head
